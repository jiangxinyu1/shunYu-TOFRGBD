...
static char str_calib_name[128] = {0};
static char str_removeINS_name[128] = {0};
...
static int V4L2_Init(void)
{
	...
	pst_camera->photo_num 		= 5000000;//�ɼ�֡�� 5000000	 
...
int GetTofRawData(TOF_RAW_DATA_CB_S *pstTofRawDataCb)
{
	...
	pstTofRawDataCb->uiFrameCnt = tofrawdata_count;///�Լ���һ��count��ȥ������capture��������
