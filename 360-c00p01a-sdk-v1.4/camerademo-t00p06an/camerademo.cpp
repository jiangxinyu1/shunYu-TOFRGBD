...
{   	
	...
	const std::string strSaveDir = ("./capture");//保存数据的目录

	const std::string strModuleName = ("T00P06AN");//模组型号
	const TOFRGBD_GUEST_ID guestID = TOFRGBD_GUEST_ID_DEF;

	const unsigned int nTofWidth = 224;//TOF数据宽
	const unsigned int nTofHeight = 114;//TOF数据高
	const unsigned int nRgbWidth = 1920;//RGB数据宽
	const unsigned int nRgbHeight = 1080;//RGB数据高
